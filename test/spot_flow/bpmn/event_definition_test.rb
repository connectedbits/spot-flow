...
#         before { @process = SpotFlow.new(source).start(variables: { simulate_error: true }) }
...
#           before { @processes = SpotFlow.new(source).start_with_message(message_name: message_name) }

    ...
    describe Definitions do
      describe :from_xml do
        ...
        describe :complex do
          ...
          #     {:id=>"Flow_0fm9oq9", :source_ref=>"Split", :target_ref=>"Gateway_0lp786q"},
          #     {:id=>"Flow_1d1hs5n", :name=>"yes", :source_ref=>"Gateway_0lp786q", :target_ref=>"GenerateFortune", :condition_expression=>"=cookie = true"},
          ...
          #     {:id=>"Flow_0ehgwup", :name=>"no", :source_ref=>"Gateway_0lp786q", :target_ref=>"Join", :condition_expression=>"=cookie = false"},
          ...
          #   :exclusive_gateway=>{:id=>"Gateway_0lp786q", :name=>"Tell Fortune?", :incoming=>"Flow_0fm9oq9", :outgoing=>["Flow_1d1hs5n", "Flow_0ehgwup"]},
          #   :boundary_event=>
